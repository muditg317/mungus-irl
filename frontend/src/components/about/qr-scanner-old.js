            ...
            for (var c = d.buildFunctionPattern(), a = !0, h = Array(d.TotalCodewords), m = 0, f = 0, g = 0, k = b - 1; 0 < k; k -= 2) {
                ...
                for (var x = 0; x < b; x++)
                    for (var v = a ? b - 1 - x : x, t = 0; 2 > t; t++)
                        if (!c.get_Renamed(k - t, v)) {
                          g++;
                          f <<= 1;
                          if (this.bitMatrix.get_Renamed(k - t, v)) {
                            f |= 1;
                          }
                          if (8 === g) {
                            h[m++] = f;
            ...
            for (var h = !1, l = Array(5), m = c - 1; m < e && !h; m += c) {
                ...
                for (var f = b = l[4] = 0; f < d; f++)
                    if (a[f + m * g.width]) {
                        ...
                        l[b]++;
                if (this.foundPatternCross(l)) {
                  if (b = this.handlePossibleCenter(l, m, d)) {
                    c = l[0];
                    if (this.hasSkipped) {
                      h = this.haveMultiplyConfirmedCenters();
                    }
        ...
        this.getFigureString = function(b) {
            ...
            do {
                if (3 <= b) {
                  ...
                  c = this.getNextBits(7);
                  if (10 > c) {
                    d += "0";
                  }
                  b -= 2;
                } else if (1 === b) {
                  c = this.getNextBits(4);
                  --b;
                }
                d += c;
            }
        ...
        decode: function(a) {
            ...
            d.onload = function() {
                ...
                var a = document.createElement("canvas")
                  ...
                  , e = d.height
                  , f = d.width;
                if (d.width * d.height > g.maxImgSize) {
                  f = d.width / d.height;
