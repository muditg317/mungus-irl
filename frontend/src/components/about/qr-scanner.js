var qrcode = function() {
    ...
    function k(h, b, e, d, c, a) {
        ...
        this.buildFunctionPattern = function() {
            ...
            6 < this.versionNumber && (c.setRegion(d - 11, 0, 3, 6),
            c.setRegion(0, d - 11, 6, 3));
            return c
        }
        ;
    ...
    function Q(h) {
        ...
        this.sizeOfBlackWhiteBlackRunBothWays = function(b, e, d, c) {
            ...
            d = b - (d - b);
            0 > d ? (h = b / (b - d),
            d = 0) : d >= g.width && (h = (g.width - 1 - b) / (d - b),
            d = g.width - 1);
            c = Math.floor(e - (c - e) * h);
            h = 1;
            0 > c ? (h = e / (e - c),
            c = 0) : c >= g.height && (h = (g.height - 1 - e) / (c - e),
            c = g.height - 1);
    ...
    function T(a) {
        ...
        this.readVersion = function() {
            ...
            var e = this.bitMatrix.Dimension
              , d = e - 17 >> 2;
            if (6 >= d)
                return k.getVersionForNumber(d);
    ...
    function w(a, b) {
        ...
        if (1 < e && 0 == b[0]) {
            for (var d = 1; d < e && 0 == b[d]; )
                d++;
            if (d == e)
                this.coefficients = a.Zero.coefficients;
            else {
    ...
    function U(a, b, e) {
        ...
        this.aboutEquals = function(d, c, b) {
            return Math.abs(c - this.y) <= d && Math.abs(b - this.x) <= d ? (d = Math.abs(d - this.estimatedModuleSize),
            1 >= d || 1 >= d / this.estimatedModuleSize) : !1
        }
    }
    function V(a) {
        this.bottomLeft = a[0];
    ...
    function S() {
        ...
        this.handlePossibleCenter = function(a, b, e) {
            ...
            if (!isNaN(b) && (e = this.crossCheckHorizontal(Math.floor(e), Math.floor(b), a[2], d),
            !isNaN(e))) {
                a = d / 7;
                ...
                null != this.resultPointCallback && this.resultPointCallback.foundPossibleResultPoint(e));
                return !0
            }
            return !1
        }
            ...
            for (var h = !1, l = Array(5), m = c - 1; m < e && !h; m += c) {
                ...
                for (var f = b = l[4] = 0; f < d; f++)
                    if (a[f + m * g.width])
                        ...
                        if (4 == b)
                            if (this.foundPatternCross(l)) {
                                if (b = this.handlePossibleCenter(l, m, f))
                                    c = 2,
                                    this.hasSkipped ? h = this.haveMultiplyConfirmedCenters() : (b = this.findRowSkip(),
                                    b > l[2] && (m += b - l[2] - c,
                                    f = d - 1));
                                else {
                                    do
                                        f++;
                                    while (f < d && !a[f + m * g.width]);f--
                                }
                                b = 0;
                                l[0] = 0;
                                l[1] = 0;
                        ...
                        l[b]++;
                this.foundPatternCross(l) && (b = this.handlePossibleCenter(l, m, d)) && (c = l[0],
    ...
    function R(a, b, e, d, c, f, l) {
        ...
        this.find = function() {
            for (var c, b = this.startX, h = this.height, f = b + d, l = e + (h >> 1), p = [0, 0, 0], k = 0; k < h; k++) {
                ...
                for (c = 0; A < f; ) {
                    if (a[A + n * g.width])
                        if (1 == c)
                            ...
                            if (this.foundPatternCross(p) && (c = this.handlePossibleCenter(p, n, A),
                            null != c))
                                return c;
                            p[0] = p[2];
                            p[1] = 1;
                ...
                if (this.foundPatternCross(p) && (c = this.handlePossibleCenter(p, n, f),
                null != c))
                    return c
            }
    ...
    function X(a, b, e) {
        ...
        this.getFigureString = function(b) {
            var c = 0
              , d = "";
            do
                3 <= b ? (c = this.getNextBits(10),
                100 > c && (d += "0"),
                10 > c && (d += "0"),
                b -= 3) : 2 == b ? (c = this.getNextBits(7),
                10 > c && (d += "0"),
                b -= 2) : 1 == b && (c = this.getNextBits(4),
                --b),
                d += c;
            while (0 < b);return d
        }
        ...
        this.parseECIValue = function() {
            ...
            0 == (c & 128) && (b = c & 127);
            128 == (c & 192) && (b = this.getNextBits(8),
            b |= (c & 63) << 8);
            192 == (c & 224) && (b = this.getNextBits(8),
            b |= (c & 31) << 16);
            return b
        }
        ;
        this.__defineGetter__("DataByte", function() {
            ...
            do {
                ...
                if (1 != c && 2 != c && 4 != c && 8 != c && 7 != c)
                    throw "Invalid mode: " + c + " in (block:" + this.blockPointer + " bit:" + this.bitPointer + ")";
                if (7 == c)
                    this.parseECIValue();
                else {
                    var a = this.getDataLength(c);
                    if (1 > a)
                        throw "Invalid data length: " + a;
                    switch (c) {
                    case 1:
    ...
    k.decodeVersionInformation = function(a) {
        for (var b = 4294967295, e = 0, d = 0; d < k.VERSION_DECODE_INFO.length; d++) {
            ...
            if (c == a)
                return this.getVersionForNumber(d + 7);
    ...
    E.rsDecoder = new function(a) {
        ...
        this.decode = function(a, e) {
            ...
            if (!h)
                for (f = new w(this.field,c),
                b = this.runEuclideanAlgorithm(this.field.buildMonomial(e, 1), f, e),
                f = b[1],
        ...
        this.findErrorLocations = function(a) {
            ...
            for (var d = Array(b), c = 0, f = 1; 256 > f && c < b; f++)
                0 == a.evaluateAt(f) && (d[c] = this.field.inverse(f),
                c++);
            if (c != b)
    ...
    var g = {
        ...
        vidSuccess: function(a) {
            g.localstream = a;
            g.webkit ? g.video.src = window.webkitURL.createObjectURL(a) : g.moz ? (g.video.mozSrcObject = a,
            g.video.play()) : g.video.src = a;
            g.gUM = !0;
        ...
        setWebcam: function(a) {
            ...
            b.getUserMedia ? b.getUserMedia({
                video: e,
                audio: !1
            }, g.vidSuccess, g.vidError) : b.webkitGetUserMedia ? (g.webkit = !0,
            b.webkitGetUserMedia({
                video: e,
                audio: !1
            }, g.vidSuccess, g.vidError)) : b.mozGetUserMedia && (g.moz = !0,
            b.mozGetUserMedia({
                video: e,
                audio: !1
        ...
        decode: function(a) {
            ...
            d.onload = function() {
                ...
                var a = document.createElement("canvas")
                  ...
                  , e = d.height
                  , f = d.width;
                d.width * d.height > g.maxImgSize && (f = d.width / d.height,
                ...
                try {
                    ...
                    console.log(y),
                    g.result = Error("error decoding QR Code")
                }
                null != g.callback && g.callback(g.result)
            }
            ;
            ...
            if (g.debug) {
                for (d = 0; d < e.bits.Height; d++)
                    for (c = 0; c < e.bits.Width; c++)
                        f = 8 * c + 2 * d * g.width * 4,
                        g.imagedata.data[f] = (e.bits.get_Renamed(c, d),
                        0),
                        g.imagedata.data[f + 1] = (e.bits.get_Renamed(c, d),
                        0),
